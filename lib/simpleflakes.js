...
const SIMPLEFLAKE_EPOCH = 946684800000 // Date.UTC(2000, 0, 1) == epoch milliseconds, since 1 Jan 2000 00:00
...
function parseSimpleflake(flake) {
  return new SimpleFlakeStruct(
    // timestamp
    (extractBits(flake, SIMPLEFLAKE_TIMESTAMP_SHIFT, SIMPLEFLAKE_TIMESTAMP_LENGTH) + BigInt(SIMPLEFLAKE_EPOCH)).toString(10),
    // random bits
