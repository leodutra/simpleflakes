...
function binary(value, padding) {
  var bignum = new BigNum(value, 10).toString(2);
  return padding !== false && bignum.length < 64 ? CACHE_64_BIT_ZEROS.substr(0, 64 - bignum.length) + bignum : bignum;
}
...
function SimpleFlakeStruct(timestamp, randomBits) {
  if (this instanceof SimpleFlakeStruct) {
    if (timestamp === void 0 || randomBits === void 0) {
