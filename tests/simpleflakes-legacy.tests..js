...
test('testing legacy simpleflake()', function(t) {
...
test('testing legacy binary()', function(t) {
...
test('testing legacy extractBits()', function(t) {
...
test('testing legacy SimpleFlakeStruct()', function(t) {
...
test('testing legacy parseSimpleflake()', function(t) {
